...
class Main:
    ...
    # products = {"kalem": {"renkler": ["mavi", "siyah", "kırmızı"], "fiyat": 5},
    #        "defter": {"renkler": ["sarı", "pembe", "yeşil"], "fiyat": 10},
    #        "kalemlik": {"renkler": ["mor", "turuncu", "beyaz"], "fiyat": 8},
    #        "bardak": {"renkler": ["şeffaf", "mavi", "kırmızı"], "fiyat": 3}}
